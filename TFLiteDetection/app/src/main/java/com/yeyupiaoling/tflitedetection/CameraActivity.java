...
import com.yeyupiaoling.tflitedetection.view.AutoFitTextureView;
import com.yeyupiaoling.tflitedetection.view.CanvasView;
...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.copyFileFromAsset(CameraActivity.this, "ssd_mobilenet_v3_coco.tflite", detectionModelPath);
        try {
            ...
            new Runnable() {
                ...
                public void run() {
                    synchronized (lock) {
                        if (runClassifier) {
                            // 开始预测前要判断相机是否已经准备好
                            if (getApplicationContext() != null && mCameraDevice != null && TFLiteDetectionUtil != null) {
                                detection();
                            }
                        }
                    }
